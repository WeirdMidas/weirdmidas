...
- 👽 [PRLMK Add-on](https://github.com/WeirdMidas/PRLMK-Addon), if you are interested in changing the dynamics of your LMKD to an implementation that resembles PRLMK (from this repository: [prlmk](https://github.com/darkhz/prlmk/tree/README) ) on your device, feel free to visit.
